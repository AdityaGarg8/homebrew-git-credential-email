class GitCredentialOutlook < Formula
  ...
  url "https://github.com/AdityaGarg8/git-credential-email/archive/refs/tags/v4.3.1.tar.gz"
  sha256 "cb7e0bb8a638761ff00e50952b8b2e84e0cee2a3b6b422d9a7f780049101fc8f"
  license "Apache-2.0"
