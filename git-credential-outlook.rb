class GitCredentialOutlook < Formula
  ...
  url "https://github.com/AdityaGarg8/git-credential-email/archive/refs/tags/v5.7.tar.gz"
  sha256 "ec3e9088442db408c7d0a35fee1cfd351bb9af3aa481004000f7f043d4d1711d"
  license "Apache-2.0"
